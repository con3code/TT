...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
		...
		timeLabelRect = CGRectMake(2, 1, 81, 38);
		kindLabelRect = CGRectMake(90, 2, 220, 19);
		destinationLabelRect = CGRectMake(90, 18, 220, 20);
...
//	[ttColorImage drawAtPoint:ttcolorPoint];
	...
	[kindLabel drawInRect:kindLabelRect withFont:[UIFont boldSystemFontOfSize:kKindLabelFontSize]];
	...
	if (diffHidden) {
		...
		if (self.diffMinus) {
			...
			[diffLabel drawInRect:CGRectMake(10, 10, 62, 16) withFont:[UIFont boldSystemFontOfSize:kDiffLabelFontSize] lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentRight];
		}
		else {
			[[UIColor blackColor] set];
			[diffLabel drawInRect:diffLabelRect withFont:[UIFont boldSystemFontOfSize:kDiffLabelFontSize] lineBreakMode:UILineBreakModeTailTruncation alignment:UITextAlignmentRight];
